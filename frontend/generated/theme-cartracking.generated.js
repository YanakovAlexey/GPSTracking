...
import stylesCss from 'themes/cartracking/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_cartracking_componentCss']) {
    
    document['_vaadintheme_cartracking_componentCss'] = true;
  }
